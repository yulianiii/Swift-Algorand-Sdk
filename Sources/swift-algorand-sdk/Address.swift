...
public class Address: Codable,Equatable {
    ...
    public func verifyBytes(byte: [Int8], signature: Signature) throws -> Bool {
        ...
        var isVerified = try publicKey.verify(
                                    signature: CustomEncoder.convertToUInt8Array(input: signature.bytes!),
                                    message: CustomEncoder.convertToUInt8Array(input: byte)
                                )
        return isVerified
    }
